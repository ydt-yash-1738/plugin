...
const QuickQuote = () => {
    ...
    return (
        <div className="min-h-screen bg-black flex items-center justify-center p-4">
            <div className="relative bg-zinc-900 text-white p-8 rounded-3xl w-full max-w-3xl shadow-[0_0_30px_10px_rgba(0,200,255,0.2)]">
                <h2 className="text-2xl font-semibold mb-6">Fill in your Property Details to Proceed</h2>
